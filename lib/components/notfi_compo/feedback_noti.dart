...
class FeedbackNoti extends StatefulWidget {
  final String? jobID;
  final String? uid;
  ...
  @override
  State<FeedbackNoti> createState() => _FeedbackNotiState();
}

class _FeedbackNotiState extends State<FeedbackNoti> {
  @override
