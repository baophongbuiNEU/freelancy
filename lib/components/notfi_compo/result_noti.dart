...
class ResultNoti extends StatefulWidget {
  final String? jobID;
  final String? uid;
  ...
  @override
  State<ResultNoti> createState() => _ResultNotiState();
}

class _ResultNotiState extends State<ResultNoti> {
  @override
              ...
              builder: (context, userSnapshot) {
                if (userSnapshot.connectionState == ConnectionState.active) {
                  if (userSnapshot.hasData) {
                    ...
                    final timestamps = (jobDetails['accepted_timestamps']
                            as List)
                                          ...
                                          RichText(
                                            text: TextSpan(
                                              children: [
                                                TextSpan(
                                                  text:
                                                      "Đơn ứng tuyển của bạn vào công việc ",
                                                  style: TextStyle(
                                                      fontSize: 16,
                                                      fontWeight:
                                                          FontWeight.normal,
