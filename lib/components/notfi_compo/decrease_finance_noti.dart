...
class DecreaseFinanceNoti extends StatefulWidget {
  final String? jobID;
  final String? uid;
  ...
  @override
  State<DecreaseFinanceNoti> createState() => _DecreaseFinanceNotiState();
}

class _DecreaseFinanceNotiState extends State<DecreaseFinanceNoti> {
  @override
                                            ...
                                            text: TextSpan(
                                              children: [
                                                ...
                                                isTips > 0
                                                    ? TextSpan(
                                                        text:
                                                            " và tips thêm cho ứng viên ${NumberFormat.currency(locale: 'vi_VN', symbol: 'đ').format(isTips)}",
                                                        style: TextStyle(
                                                            fontSize: 16,
                                                            fontWeight:
                                                                FontWeight.bold,
