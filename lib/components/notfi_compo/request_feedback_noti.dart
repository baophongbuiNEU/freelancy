...
class RequestFeedbackNoti extends StatefulWidget {
  final String? jobID;
  final String? uid;
  ...
  @override
  State<RequestFeedbackNoti> createState() => _RequestFeedbackNotiState();
}

class _RequestFeedbackNotiState extends State<RequestFeedbackNoti> {
  @override
                                          ...
                                          RichText(
                                            text: TextSpan(
                                              children: [
                                                ...
                                                TextSpan(
                                                  text:
                                                      " muốn xin feedback của bạn cho công việc ",
                                                  style: TextStyle(
                                                      fontSize: 17,
                                                      fontWeight:
                                                          FontWeight.normal,
